...
# ================= WORD TO PDF – WEASYPRINT + FONT DOWNLOAD =================
    ...
    if not os.path.exists(font_path):
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                logging.warning("Font download failed, using system fallback.")
        except Exception as e:
            logging.warning(f"Font download error: {e}")
    return font_path
    ...
    try:
        ...
        for para in doc.paragraphs:
            ...
            for run in para.runs:
                ...
                if run.font.name:
                    styles.append(f"font-family: '{run.font.name}', 'DejaVuSans', sans-serif")
                if styles:
